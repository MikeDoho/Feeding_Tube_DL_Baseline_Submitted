...
from lib.Models import resnet, resnet_class, resnet_fork_dropout
    ...
    if opt.model == 'resnet':
        ...
        if opt.in_modality == 3 and opt.is_classi:
            ...
            if opt.model_depth == 10:
                model = resnet_fork_dropout.resnet10(
                ...
                model = resnet_fork_dropout.resnet18(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_dropout.resnet34(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_dropout.resnet50(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_dropout.resnet101(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_dropout.resnet152(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_dropout.resnet200(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
